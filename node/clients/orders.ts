    ...
    return this.http.get(
      `https://${ctx.vtex.account}.vtexcommercestable.com.br/api/dataentities/CL/search?_fields=email&_where=userId%3D${userId}&_schema=CL&_keyword=String%20to%20search&_sort=firstName%20ASC`,
      {
        headers: {
          ...
          'X-VTEX-API-AppKey': 'vtexappkey-hiringcoders202115-OUWHMN',
          'X-VTEX-API-AppToken': 'ZDOGYYQOZYZRRAPJTZBDVPDTOMKGTMCYWUPJVZGKSZYDYMAERJCGBLQJAVRMNKVNWBVXLGNUSRLWRZUBMFOKKWWKDFJAHUWHEKHXRDTLVHNJZUSAAQAIWKDZEKTFWNNY'
        },
      }
    )
  }
